...
/* package matexpo-0.1.0.0 */
#ifndef VERSION_matexpo
#define VERSION_matexpo "0.1.0.0"
#endif /* VERSION_matexpo */
#ifndef MIN_VERSION_matexpo
#define MIN_VERSION_matexpo(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_matexpo */
...
#define CURRENT_COMPONENT_ID "matexpo-0.1.0.0-inplace-matexpo"
